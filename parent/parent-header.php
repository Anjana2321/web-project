    ...
    <div class="offcanvas offcanvas-end" id="navbarOffcanvas"  tabindex="-1" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">          
          <div class="navbar-nav justify-content-end flex-grow-1 pe-3 align-items-center navigation">
            ...
            <a class="nav-item nav-link" href="parent-event.php"><i class="fa me-2 fa fa-first-order" aria-hidden="true"></i> Events</a>
            <a class="nav-item nav-link" href="parent-homework.php"><i class="fa me-2 fa-file-text-o" aria-hidden="true"></i> Homework</a>
            <a class="nav-item nav-link" href="parent-payment-page.php"><i class="fa me-2 fa-files-o" aria-hidden="true"></i> Finance Report</a>
            <a class="nav-item nav-link" href="parent_notification.php"><i class="fa me-2 fa-bell-o" aria-hidden="true"></i> Notification <?php if ($unreadCount > 0): ?>
          ...
          <div class="d-flex align-items-center">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="profile.php"><i class="fa me-2 fa-user" aria-hidden="true"></i> Profile</a></li>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (unreadCount === 0) {
        document.querySelector('parent-notification .badge').style.display = 'none';
    }
});
</script>