    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div id="notificationForm" class="registration-form mt-3">
                ...
                <form method="POST" action="staff_insert_notification.php" class="reg-form" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <input type="uploaded_by" class="form-control" name="uploaded_by" value="Faculty" id="uploaded_by" placeholder="Enter Uploaded By" required readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
