    ...
    <div class="offcanvas offcanvas-end" id="navbarOffcanvas"
        ...
        <div class="offcanvas-body">          
          <div class="navbar-nav justify-content-end flex-grow-1 pe-3 align-items-center navigation">
            <a class="nav-item nav-link " aria-current="page" href="calendar.php"><i class="fa me-2 fa-home" aria-hidden="true"></i> Home</a>
            <a class="nav-item nav-link" href="student-attendance.php"><i class=" fa fa-calendar" aria-hidden="true"></i> Attendance Sheet</a>
            <a class="nav-item nav-link" href="    "><i class="fa me-2 fa-graduation-cap" aria-hidden="true"></i> Report</a>
            <a class="nav-item nav-link" href="student-homework.php"><i class="fa me-2 fa-file-text-o" aria-hidden="true"></i> Homework</a>
            <a class="nav-item nav-link" href="student-event.php"><i class="fa me-2 fa fa-first-order" aria-hidden="true"></i>Events</a>
            <a class="nav-item nav-link" href="financial.php"><i class="fa me-2 fa-files-o" aria-hidden="true"></i>Financial Report</a>
            <a class="nav-item nav-link" href="student_notification.php">
            ...
            <a class="nav-item nav-link mob-nav" href="#"><i class="fa me-2 fa-user" aria-hidden="true"></i> Profile</a>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (unreadCount === 0) {
        document.querySelector('student-notification .badge').style.display = 'none';
    }
});
</script>
